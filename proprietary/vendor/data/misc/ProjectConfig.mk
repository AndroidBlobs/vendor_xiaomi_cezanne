...
CUSTOM_HAL_ANT = mt6885_ant_m1
CUSTOM_HAL_AUDIOFLINGER = audio
CUSTOM_HAL_CAMERA = camera
CUSTOM_HAL_COMBO = mt6885
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = imx682sunny_mipi_raw s5k3t2sunny_mipi_raw s5k3t2ofilm_mipi_raw ov02b1bofilm_mipi_raw s5k5e9sunny_mipi_raw hi1337sunny_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = ov02b1b_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = imx682sunny_mipi_raw
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = s5k3t2sunny_mipi_raw s5k3t2ofilm_mipi_raw
CUSTOM_HAL_LENS = dw9800af dummy_lens
...
CUSTOM_KERNEL_IMGSENSOR = imx682sunny_mipi_raw s5k3t2sunny_mipi_raw s5k3t2ofilm_mipi_raw ov02b1bofilm_mipi_raw s5k5e9sunny_mipi_raw hi1337sunny_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = ov02b1b_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx682sunny_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3t2sunny_mipi_raw s5k3t2ofilm_mipi_raw
CUSTOM_KERNEL_LENS = dw9800af dummy_lens
...
MTK_CAM_AIAWB_SUPPORT = yes
MTK_CAM_AIHDR_SUPPORT = 1
...
MTK_DPM_SUPPORT = yes
MTK_DRE30_SUPPORT = yes
MTK_AALINPQ_SUPPORT = yes
MTK_DRM_APP = no
...
MTK_GPU_SUPPORT = yes
MTK_GPU_VERSION = mali valhall r21p0
...
else ##do not use default mtk apk in miui
...
MTK_TOUCHPANEL_FIRMWARE = GT9886
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
...
MTK_DISP_GAME_PQ_SUPPORT = yes
MTK_GRAPHIC_LOW_LATENCY_VERSION = 0
MTK_PCIE_SMT_SUPPORT = no
MTK_VIDEO_TRANSITION = no
MTK_VIDEO_ENHANCEMENT = no
MTK_APUSYS_RT_SUPPORT = no
MTK_THP_SUPPORT = no
MTK_VOW_COMMAND_3RD = none
MTK_VOW_COMMAND_2ND = none
MTK_VOW_COMMAND = keyword02
MTK_GWSD_V2_SUPPORT = yes
MTK_NEBULA_VM_SUPPORT = no
MTK_NFC_CLKBUF_ENABLE = no
XIAOMI_NFC_CLKBUF_ENABLE=yes
MTK_HIGH_FRAME_RATE_T2D_LOW_LANTENCY = no
MTK_TOUCH_LOW_LATENCY = 0
MTK_CAM_MFB_MAX_FRAME = 6
MTK_CAM_4CELL_MFNR_SUPPORT = no
MTK_MD_GNSS_SYNC = no
MTK_CONSYS_EFEM_SUPPORT = no
MICROTRUST_THH_SUPPORT = yes
MTK_SOTER_SUPPORT = yes
MTK_PAPE = 1
MTK_CAM_GENIEZONE_SUPPORT = no
